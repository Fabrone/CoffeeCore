      ...
      body: Center(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image.asset('assets/coffee_login.png', width: 200.0), // Updated asset
              ...
              TextButton(
                ...
                child: Text(
                  ...
                  style: TextStyle(color: Colors.brown[700], fontSize: 16.0),
                ),
              ),
            ],
          ),
  ...
  Widget _buildTextField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: Colors.brown[50], // Light coffee tone
      ),
      validator: validator,
    );
  }
